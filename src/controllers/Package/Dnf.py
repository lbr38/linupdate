        ...
        if update_method == 'one_by_one':
            ...
            for pkg in packagesList:
                ...
                if popen.returncode != 0:
                    ...
                    # Print error message for the package
                    print(' ▪ Error while updating ' + Fore.RED + pkg['name'] + Style.RESET_ALL)
                ...
                # Print success message for the package
                print(' ▪ ' + Fore.GREEN + pkg['name'] + Style.RESET_ALL + ' updated successfully')
