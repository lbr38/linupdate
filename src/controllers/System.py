...
class System:
    ...
    def get_os_family(self):
        ...
        if (distro.name() in ['Red Hat Enterprise Linux', 'CentOS Linux', 'CentOS Stream', 'Fedora', 'Fedora Linux', 'AlmaLinux', 'Alma Linux', 'RockyLinux', 'Rocky Linux', 'Oracle Linux Server']):
            return 'Redhat'
